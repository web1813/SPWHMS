...
$con=mysqli_connect("localhost","root","","myhmsdb") or die(mysql_error());
$atmp = 0;
if(isset($_POST["patsub"])){  
    ...
    if(!empty($_POST['email']) && !empty($_POST['password2'])) {  
      ...
      // }
        ...
        if($atmp < 3) {
        $query=$query="select * from patreg where email='$user' and password='$pass'"; 
        $result=mysqli_query($con,$query);
            ...
            {  
              ...
              // echo("<script>alert(`Please provide valid Information`);
              // window.location.href = 'index1.php';</script>"); 

              // , and the number of attempt is $atmp 
            }  
      ...
      $_SESSION["login_attempts"] += 1;
      echo("<script>window.location.href = 'index1.php';</script>");
      // echo("<script>alert('Invalid method call. Try Again!');
      // window.location.href = 'index1.php';</script>"); 
    }  
}  
